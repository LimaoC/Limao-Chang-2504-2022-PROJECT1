...
Returns a vector of tuples of (irreducible polynomials (mod p), multiplicity) such that
...
Given a square free polynomial `f` returns a list, `g` such that `g[k]` is a product of
